...
public class UserCacheService {
    ...
    // 캐시 저장
    public void saveUserCache(String nickname, UserSearchResponse userSearchResponse) {

        String key = CACHE_USER_PREFIX + nickname;

        redisTemplate.opsForValue().set(key, userSearchResponse, 10, TimeUnit.MINUTES);
    }
}